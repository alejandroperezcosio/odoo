            ...
            for line in order.order_line:
                ...
                for subline in line.product_id.pack_line_ids:
                    ...
                    vals = {
                        ...
                        'procurement_id': line.procurement_ids and line.procurement_id.ids or False,
                        'price_unit': price,
                        'tax_id': [(6,0,tax_ids)],
                        # 'type': subproduct.procure_method, # THIS LINE WAS REMOVED SINCE THIS IS NOT SUPORTED ANYMORE ON ODOO 8
                        'property_ids': [(6,0,[])],
